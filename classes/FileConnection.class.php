...
class FileConnection {
	...
	public function __construct(){
		$services_servicepoint = variable_get("services_rest_client_basefileurl");
		$username = variable_get("services_rest_client_fileusername");
		$password = variable_get("services_rest_client_filepassword");
